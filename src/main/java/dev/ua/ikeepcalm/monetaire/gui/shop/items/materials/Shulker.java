...
public class Shulker extends AbstractItem {

    private Advertiser advertiser;
    private Material material;
    private boolean enoughMoney;

    public Shulker(Advertiser advertiser, Material materials) {
    ...
    public ItemProvider getItemProvider() {
        int price = Configuration.getConfiguration().getInt("shulker");
        int quantity = Configuration.getConfiguration().getInt("q_shulker");
