...
public class Flower extends AbstractItem {
    ...
    public Flower(Advertiser advertiser, Material materials) {
    ...
    public ItemProvider getItemProvider() {
        int price = Configuration.getConfiguration().getInt("flower");
        int quantity = Configuration.getConfiguration().getInt("q_flower");
