...
public class Building extends AbstractItem {

    private Advertiser advertiser;
    private Material material;
    private boolean enoughMoney;

    public Building(Advertiser advertiser, Material materials) {
    ...
    public ItemProvider getItemProvider() {
        ...
        int quantity = Configuration.getConfiguration().getInt("q_building_block");
