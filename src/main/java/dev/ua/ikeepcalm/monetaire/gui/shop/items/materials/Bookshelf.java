...
public class Bookshelf extends AbstractItem {

    private Advertiser advertiser;
    private Material material;
    private boolean enoughMoney;

    public Bookshelf(Advertiser advertiser, Material materials) {
    ...
    public ItemProvider getItemProvider() {
        int price = Configuration.getConfiguration().getInt("bookshelf");
        int quantity = Configuration.getConfiguration().getInt("q_bookshelf");
