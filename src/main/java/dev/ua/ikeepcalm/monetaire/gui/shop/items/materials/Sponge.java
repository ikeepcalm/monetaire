...
public class Sponge extends AbstractItem {

    private Advertiser advertiser;
    private Material material;
    private boolean enoughMoney;

    public Sponge(Advertiser advertiser, Material materials) {
    ...
    public ItemProvider getItemProvider() {
        int price = Configuration.getConfiguration().getInt("sponge");
        int quantity = Configuration.getConfiguration().getInt("q_sponge");
