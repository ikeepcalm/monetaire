...
public class Firework extends AbstractItem {
    ...
    public Firework(Advertiser advertiser, Material materials) {
    ...
    public ItemProvider getItemProvider() {
        int price = Configuration.getConfiguration().getInt("firework");
        int quantity = Configuration.getConfiguration().getInt("q_firework");
