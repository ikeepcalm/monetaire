...
public class NetherStar extends AbstractItem {

    private Advertiser advertiser;
    private Material material;
    private boolean enoughMoney;

    public NetherStar(Advertiser advertiser, Material materials) {
    ...
    public ItemProvider getItemProvider() {
        int price = Configuration.getConfiguration().getInt("nether_star");
        int quantity = Configuration.getConfiguration().getInt("q_nether_star");
