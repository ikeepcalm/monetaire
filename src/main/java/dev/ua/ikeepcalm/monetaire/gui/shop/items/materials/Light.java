...
public class Light extends AbstractItem {
    ...
    public Light(Advertiser advertiser, Material materials) {
    ...
    public ItemProvider getItemProvider() {
        int price = Configuration.getConfiguration().getInt("light");
        int quantity = Configuration.getConfiguration().getInt("q_light");
