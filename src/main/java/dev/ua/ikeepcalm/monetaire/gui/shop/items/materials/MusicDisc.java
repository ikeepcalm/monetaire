...
public class MusicDisc extends AbstractItem {

    private Advertiser advertiser;
    private Material material;
    private boolean enoughMoney;

    public MusicDisc(Advertiser advertiser, Material materials) {
    ...
    public ItemProvider getItemProvider() {
        int price = Configuration.getConfiguration().getInt("music_disc");
        int quantity = Configuration.getConfiguration().getInt("q_music_disc");
