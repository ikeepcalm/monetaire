...
public class Decoration extends AbstractItem {
    ...
    public Decoration(Advertiser advertiser, Material materials) {
    ...
    public ItemProvider getItemProvider() {
        int price = Configuration.getConfiguration().getInt("decoration_block");
        int quantity = Configuration.getConfiguration().getInt("q_decoration_block");
