...
public class Carpet extends AbstractItem {

    private Advertiser advertiser;
    private Material material;
    private boolean enoughMoney;

    public Carpet(Advertiser advertiser, Material materials) {
    ...
    public ItemProvider getItemProvider() {
        int price = Configuration.getConfiguration().getInt("carpet");
        int quantity = Configuration.getConfiguration().getInt("q_carpet");
