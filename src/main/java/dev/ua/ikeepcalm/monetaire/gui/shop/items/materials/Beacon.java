...
public class Beacon extends AbstractItem {
    ...
    public Beacon(Advertiser advertiser, Material materials) {
    ...
    public ItemProvider getItemProvider() {
        int price = Configuration.getConfiguration().getInt("beacon");
        int quantity = Configuration.getConfiguration().getInt("q_beacon");
