...
public class Sapling extends AbstractItem {

    private Advertiser advertiser;
    private Material material;
    private boolean enoughMoney;

    public Sapling(Advertiser advertiser, Material materials) {
    ...
    public ItemProvider getItemProvider() {
        int price = Configuration.getConfiguration().getInt("tree_sapling");
        int quantity = Configuration.getConfiguration().getInt("q_tree_sapling");
