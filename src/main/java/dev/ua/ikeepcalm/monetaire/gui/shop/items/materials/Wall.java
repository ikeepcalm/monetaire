...
public class Wall extends AbstractItem {
    ...
    public Wall(Advertiser advertiser, Material materials) {
    ...
    public ItemProvider getItemProvider() {
        int price = Configuration.getConfiguration().getInt("wall");
        int quantity = Configuration.getConfiguration().getInt("q_wall");
